...
# Method to convert tensor of labels to 4 corner points, wrote to help with iou calculation
def to_corners(arr):
    batch = arr.size()[0]
...
# Method to stack label and prediction but 2 head detector with 2 step training had better results by the time I finished with this one
...
# Used to unnormalize the data to its original form during inference
...
# Normalize Classifier labels at 0 or 1 for classifier head training
